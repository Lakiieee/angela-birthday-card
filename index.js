...
import { Heart, Balloon, Sparkles } from "lucide-react";
import './index.css';
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-100 to-blue-50 p-6 flex flex-col items-center justify-center space-y-8 relative overflow-hidden">
      <audio autoPlay loop controls className="absolute top-4 right-4 w-48 opacity-60">
        <source src="/final-fantasy-lullaby.mp3" type="audio/mpeg" />
        ...
        <div className="bg-white shadow-lg rounded-2xl p-4">
          <div className="text-center">
            <p className="text-md text-gray-600 italic">
              "Happy 24th birthday, Angela. I'm sorry that I can't be with you, but hopefully this card makes you smile, and I really hope you enjoy the gifts that I've got you, and they should arrive as well. Love, your English nerd."
            </p>
          </div>
        </div>
      </motion.div>
      ...
      >
        ...
        <div className="flex justify-center space-x-4 text-pink-400 text-xl">
          <Balloon className="animate-bounce" />
        ...
        <div className="mt-4 text-sm text-purple-600 italic">
          "You’ve unlocked a new quest: Birthday Cheer + Romance + Cozy Nerdiness 💖"
        </div>
      </motion.div>
    </div>
  );
